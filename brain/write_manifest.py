# ============================================================
#  NXIO — brain/models/write_manifest.py
#  Scans brain/models/ and writes manifest.json
#  Run: python brain/models/write_manifest.py
# ============================================================
...
def build_manifest():
    ...
    for symbol in SYMBOLS:
        for tf in TIMEFRAMES:
            ...
            if me:
                ...
                entry["model_modified"] = datetime.fromtimestamp(
    ...
    manifest["summary"] = {"total": len(manifest["models"]),
                           "ready": ready, "missing": len(manifest["models"]) - ready}
    return manifest
